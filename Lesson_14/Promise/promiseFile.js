...
todoOne(energy).then(value => {
    console.log(value);

    return todoTwo(energy).then(value1 => {
        console.log(value1);

        return todoThree(energy).then((value2 => {
            console.log(value2);

            return todoFour(energy).then(value3 => {
                console.log(value3);

                return todoFive('Sunny').then(value4 => {
                    console.log(value4);

                    return todoSix(money, energy).then(value5 => {
                        console.log(value5);

                        return todoSeven(money).then((value6 => {
                            console.log(value6);

                            return todoEight('King Kong', money).then(value7 => {
                                console.log(value7);

                                return todoNine(energy).then(value8 => {
                                    console.log(value8);

                                    return todoTen(true).then(value9 => {
                                        console.log(value9);
